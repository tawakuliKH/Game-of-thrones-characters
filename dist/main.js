...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _apiConfig_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./apiConfig.js */ \"./src/modules/apiConfig.js\");\n\n\nconst likesCount = async (index) => {\n  const likesJson = await (0,_apiConfig_js__WEBPACK_IMPORTED_MODULE_0__.getLikes)();\n  let likeTotal = 0;\n  likesJson.forEach((likesss) => {\n    if (likesss.item_id === index) likeTotal = likesss.likes;\n  });\n  return likeTotal;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (likesCount);\n\n//# sourceURL=webpack://leaderboard-list-app/./src/modules/likesCount.js?");
